...
(function($){
    ...
    function loadYoutube(autoplay){
      ...
      var videoid = pezzi[pezzi.length-1];
      var stringAutoplay = autoplay ? "?autoplay=1" : "";
      content.html('<iframe width="560" height="315" webkitallowfullscreen mozallowfullscreen allowfullscreen src="//www.youtube.com/embed/'+videoid+stringAutoplay+'?rel=0&controls=0&showinfo=0&frameborder=0"></iframe>');
      updateoverlay();
    }
